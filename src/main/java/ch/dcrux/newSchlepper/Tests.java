...
public class Tests {
    public static void main(String[] args) {
        ...
        final DataTarget id = DataTarget.dataOrOuid(DataOrUid.data(Uid.c("BC78ABBF-FB2B-470D-8047-5393EFD3441A")));
        store.run(server, CommandList.c(new AddData(id.getOne().getUid(), new Int32Meta()),
                new Int32Get(id),
                new Int32Set(id, 343),
                new Int32Get(id)));
