...
import ch.xcrux.schlepper.ChangeInfo;
import ch.xcrux.schlepper.DataId;
import ch.xcrux.schlepper.IChange;
import ch.xcrux.schlepper.IRollbackableChange;
 ...
 */
public class SetValueChange implements IChange<CompositeData, CompositeMeta,
        Void> {
